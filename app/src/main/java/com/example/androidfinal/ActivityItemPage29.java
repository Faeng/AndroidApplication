...
public class ActivityItemPage29 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        never = findViewById(R.id.item29_checkBox_level0);
        rarely = findViewById(R.id.item29_checkBox_level2);
        always = findViewById(R.id.item29_checkBox_level4);
        hardly = findViewById(R.id.item29_checkBox_level1);
        often = findViewById(R.id.item29_checkBox_level3);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(never.isChecked() || rarely.isChecked() || always.isChecked() || hardly.isChecked() || often.isChecked()) {
                    Intent intent = new Intent(getApplicationContext(), ActivityItemPage30.class);
                    answer.add(level);
    ...
    public void onCheckboxClicked(View view) {
        switch(view.getId()) {
            case R.id.item29_checkBox_level0:
                ...
                level = 0;
                break;
            case R.id.item29_checkBox_level2:
                ...
                level = 2;
                break;
            case R.id.item29_checkBox_level4:
                rarely.setChecked(false);
                never.setChecked(false);
                hardly.setChecked(false);
                often.setChecked(false);
                level = 4;
                break;
            case R.id.item29_checkBox_level1:
                rarely.setChecked(false);
                always.setChecked(false);
                never.setChecked(false);
                often.setChecked(false);
                level = 1;
                break;
            case R.id.item29_checkBox_level3:
                rarely.setChecked(false);
                always.setChecked(false);
                hardly.setChecked(false);
                never.setChecked(false);
